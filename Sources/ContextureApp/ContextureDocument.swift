...
/// An abstract base Document (CONTEXT.md) backed by a local file.
/// Provides shared persistence, autosave, file watching, external conflict
/// handling, and Selection Snapshot arming and publishing across formats
/// (Markdown, HTML). Format-specific subclasses declare their `FormatTag`.
class ContextureDocument: NSDocument {
    var format: FormatTag {
        fatalError("Subclasses must provide format")
    }
