...
/// rather than shared, since test targets don't import one another's
/// sources — the logic itself is intentionally identical.
enum AdapterBinaryLocator {
    static func find(named binaryName: String) -> URL? {
        ...
        // debug symbol file (`CodexAdapter.dSYM/.../DWARF/CodexAdapter`)
